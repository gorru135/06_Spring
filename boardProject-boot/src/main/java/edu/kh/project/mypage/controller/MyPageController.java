...
public class MyPageController {
	 ...
	 * @return "myPage/myPage-info"로 요청위임
	 */
	@GetMapping("info")
	public String info(
	 ...
	 * @param loginMember : 로그인한 회원의 정보(회원 번호 사용할 예정)
	...
	public String fileupload1(@RequestParam("uploadFile")
	...
	/** 파일 목록 조회 
	 * @param model
	 * @return redirect:/myPage/fileList
	 */
	@GetMapping("fileList")

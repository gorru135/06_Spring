...
public class FileConfig implements WebMvcConfigurer{
	...
	private String profileResoruceLocation;
	// 요청 주소에 따라
	// 서버 컴퓨터의 어떤경로에 접근할지 설정 
	...
	public void addResourceHandlers(ResourceHandlerRegistry registry) {
		...
		.addResourceLocations(profileResoruceLocation); // file:///C:/uploadFiles/profile/
		
		// file:///C: 는 파일 시스템의 루트 디렉토리
		
		// file:// 은 URL 스킴(Scheme), 파일 시스템의 리소스
		// /C: 는 Windows 시스템에서 C드라이브 를 가리킴. 
	...
	public MultipartResolver multipartResolver() {
		...
		// 이 중에서 업로드된 파일을 추출하여 MultipartFile 객체로 제공하는 역활 

...
CREATE USER spring_psc IDENTIFIED BY spring1234;

GRANT CONNECT, RESOURCE TO spring_psc;

ALTER USER spring_psc DEFAULT TABLESPACE SYSTEM QUOTA UNLIMITED ON SYSTEM;

...
@Controller // 응답/요청 제어 역활을 명시 Bean객체 생성 spring이 관리
...
public class TodoController {
	...
	/** 완료 여부 변경 
	 * @param todo : 커맨드 객체 (@ModelAttribute 어노테이션 생략 가능)
	 * 				- todoNo, complete 두 필드가 세팅된 상태
	 * 
	 * @param ra 
	 * @return "redirect:detail?todoNo="+todo.getTodoNo() = 할 일 번호(상대경로)
	 */

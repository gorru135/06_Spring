...
(function(w) {
    ...
    try {
        var links = ["https:\/\/mat.adpies.com\/mat\/init?oaid=59757b191aa649be38b68d4c6914f838\u0026landing=https%3A%2F%2Fastg.widerplanet.com%2Fdelivery%2Fwpp.php%3Fwpg%3Dadpies_rtb%26oaid%3D59757b191aa649be38b68d4c6914f838","https:\/\/cm.g.doubleclick.net\/pixel?google_nid=wider_planet\u0026google_cm\u0026google_ula=12153253,1707787226\u0026poaid=59757b191aa649be38b68d4c6914f838","https:\/\/cm-exchange.toast.com\/bi\/pixel?cm_pid=1107948209\u0026puid=59757b191aa649be38b68d4c6914f838\u0026toast_push"],
            len = links.length,
            i;
        for (i=0; i<len; i++) {
            doPair(links[i]);
...
(function() {
var ttd = new Image();
ttd.src = "https:\/\/match.adsrvr.org\/track\/cmf\/generic?ttd_pid=ven6wdk\u0026ttd_tpi=1\u0026ttd_puid=59757b191aa649be38b68d4c6914f838";
})();
/*]]>*/
...
(function(w) {
    try {
        ...
        if (wp_uid) {
            ...
            if (is_wp_uid) {
                identity.setCookie('_wp_uid', "2-59757b191aa649be38b68d4c6914f838-s1705916165.691681|windows_10|chrome-cuf0a7", 365);
                return;
            }
        }

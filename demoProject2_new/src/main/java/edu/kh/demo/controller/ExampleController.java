...
public class ExampleController {
	...
	@GetMapping("ex1")
	public String ex1(HttpServletRequest req, org.springframework.ui.Model model) {
		...
		stdList.add(new Student("22222","최이번",22));
		stdList.add(new Student("33333","홍삼번",26));
	
		model.addAttribute("stdList",stdList);
		
		return "example/ex1"; // templates/example1/ex1.html 요청 위임
